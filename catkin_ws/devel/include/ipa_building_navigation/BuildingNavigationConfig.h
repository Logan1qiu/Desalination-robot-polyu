...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("planning_method", "int", 0, "Trolley placement method (only applies to CheckpointBasedPlanning problem)", "{'enum': [{'name': 'DragTrolleyWhenNecessary', 'type': 'int', 'value': 1, 'srcline': 23, 'srcfile': '/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Drag the trolley if it is too far away from next room.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'PrecomputeRoomGroupsAndCorrespondingTrolleyPosition', 'type': 'int', 'value': 2, 'srcline': 24, 'srcfile': '/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Put rooms together in groups and calculate a corresponding trolley positions.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Trolley placement method (only applies to CheckpointBasedPlanning problem)'}", &BuildingNavigationConfig::planning_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(BuildingNavigationConfig::AbstractParamDescriptionConstPtr(new BuildingNavigationConfig::ParamDescription<int>("planning_method", "int", 0, "Trolley placement method (only applies to CheckpointBasedPlanning problem)", "{'enum': [{'name': 'DragTrolleyWhenNecessary', 'type': 'int', 'value': 1, 'srcline': 23, 'srcfile': '/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Drag the trolley if it is too far away from next room.', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'PrecomputeRoomGroupsAndCorrespondingTrolleyPosition', 'type': 'int', 'value': 2, 'srcline': 24, 'srcfile': '/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg', 'description': 'Put rooms together in groups and calculate a corresponding trolley positions.', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'Trolley placement method (only applies to CheckpointBasedPlanning problem)'}", &BuildingNavigationConfig::planning_method)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_NearestNeighbor = 1;
//#line 10 "/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_GeneticSolver = 2;
//#line 11 "/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_ConcordeSolver = 3;
//#line 16 "/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_SimpleOrderPlanning = 1;
//#line 17 "/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_CheckpointBasedPlanning = 2;
//#line 23 "/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg"
      const int BuildingNavigation_DragTrolleyWhenNecessary = 1;
//#line 24 "/home/hp/catkin_ws/src/ipa_coverage_planning/ipa_building_navigation/cfg/BuildingNavigation.cfg"
