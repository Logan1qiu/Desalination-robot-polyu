...
int main(int argc, char *argv[])
{
  ...
  ros::Subscriber sub1 = next_goal.subscribe("/tracked_pose", 10000, pose_callback);
  ...
  pub_passed_path = next_goal.advertise<nav_msgs::Path>("/clean_robot/passed_path", 10000);
