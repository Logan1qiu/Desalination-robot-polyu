...
namespace ipa_room_exploration
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(CoverageMonitorConfig &config, const CoverageMonitorConfig &max, const CoverageMonitorConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const CoverageMonitorConfig &config1, const CoverageMonitorConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, CoverageMonitorConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const CoverageMonitorConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, CoverageMonitorConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const CoverageMonitorConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const CoverageMonitorConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, CoverageMonitorConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
