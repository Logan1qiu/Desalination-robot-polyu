...
#ifndef __MROBOT_DRIVE_NODE_H_
#define __MROBOT_DRIVE_NODE_H_
...
{
	short accele_x_data = 0; 
	short accele_y_data = 0; 	
	short accele_z_data = 0; 
    short gyros_x_data = 0; 
	short gyros_y_data = 0; 	
	short gyros_z_data = 0; 
...
class turn_on_robot
{
	public:
		...
		string usart_port_name, robot_frame_id, imu_frame_id, odom_frame_id;
		bool ifSend;
	private:
